    ...
    case "+":
      switch (randomNumber10) {
        case 0:
          let $numbers = [5, 2, 1];
          let $operation = [
            '<i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i>',
            "+",
        ...
        case 2:
          let $numbers2 = [3, 6, 9];
          let $operation2 = [
            '<i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i>',
            "+",
            '<i class="bi bi-airplane-engines"></i> <i class="bi bi-airplane-engines"></i>',
          ];
    ...
    case "-":
      switch (randomNumber10) {
        ...
        case 6:
          let $numbers6 = [1, 2, 3];
          let $operation6 = [
            '<i class="bi bi-balloon"></i> <i class="bi bi-balloon"></i> <i class="bi bi-balloon"></i> </i> <i class="bi bi-balloon"></i> <i class="bi bi-balloon"></i>',
            "-",
