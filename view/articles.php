...
<head>
    ...
    <title>Articulos | Espacio N  </title>
    ...
    <main>
        <section class="content">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum quae quo animi autem iure quod error
                ...
                neque impedit!</p>
            <a href="./article/guide.php" class="text-decoration-none">
            ...
            <a href="./article/visionAndMission.php" class="text-decoration-none">
            <div class="card mb-3 w-100">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="..." class="img-fluid rounded-start" alt="...">
            ...
            <a href="./article/BenefitsSpaceN.php" class="text-decoration-none">
            <div class="card mb-3 w-100">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="..." class="img-fluid rounded-start" alt="...">
