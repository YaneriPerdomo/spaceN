...
<head>
    ...
    <title>Tema 1 | Lección 1 | Espacio N </title>
...
<body>
            ...
            <main class="play">
                <div class="row w-100 h-100">
                    <div class="col-12 align-items-center justify-content-center d-flex">
                        <div class="containerPlayer align-items-center justify-content-center d-flex gap-3 flex-wrap" data-moreLess="more">
    ...
    <script src="../../../../../js/user/numericoEmerging/topicOne/lesson01.js" type="module">
    </script>
