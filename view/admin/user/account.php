                ...
                <div class="accordion accordion-flush content " id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="p-0 m-1 accordion-button youDeleteAccount collapsed" type="button"
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p>Mediante esta opción podrás eliminar por completo tu cuenta Profesional en "Eres
                                    Capaz"
                                    <b>al eliminar tu cuenta, ya no tendrás acceso, teniendo en cuenta que todos los
                                        usuarios
                                        que hayas creado, también serán eliminados</b> por lo que no podrán acceder a la
                                    plataforma
                                    de aprendizaje.
                                </p>
