        ...
        <div class="modal-content">
            ...
            <form action="./../../php/sendNotificationChild.php" method="post">
                <div class="modal-body">
                    ...
                    <input type="text" name="id_profesional" value="<?php echo $_SESSION["id_admin"]?> ">
                    <select name="messenger"class="w-100">
                        <option selected value="✅ ¡Felicidades! Has completado una lección mas.">✅ ¡Felicidades! Has completado una lección mas. </option>
                        <option value="¡Genial! Has ganado más estrellas. ✨"> ¡Genial! Has ganado más estrellas. ✨</option>
                        <option value="¡Lo lograste! Has superado la etapa 1."> ¡Lo lograste! Has superado la etapa 1. </option>
                        <option value="¡Sigue así! Has pasado a la etapa 2."> ¡Sigue así! Has pasado a la etapa 2. </option>
                        <option value="¡Enhorabuena! Has completado todo el aprendizaje."> ¡Enhorabuena! Has completado todo el aprendizaje. </option>
                        <option value="⬆️ ¡Ascendiste en la tabla de clasificación! Estás más cerca de la cima.">⬆️ ¡Ascendiste en la tabla de clasificación! Estás más cerca de la cima.
                        </option>
