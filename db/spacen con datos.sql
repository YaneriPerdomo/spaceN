...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2025 a las 15:28:38
...
INSERT INTO `estado_lecciones` (`id_estado_leccion`, `id_leccion`, `id_profesional`, `id_usuario`, `completado`, `porcentaje`, `diamantes_obtenidos`, `tiempo`, `fallida`) VALUES
(25, 5, 5, '12', 'completado', 100, 20, '00:02:46', 0),
(26, 6, 5, '12', 'completado', 85, 17, '00:03:36', 3),
(27, 7, 5, '12', 'completado', 60, 12, '00:03:32', 8),
(28, 8, 5, '12', 'completado', 5, 1, '00:01:25', 19),
(29, 9, 5, '13', 'completado', 25, 5, '00:01:48', 15),
(30, 10, 5, '13', 'completado', 55, 11, '00:01:05', 9),
(31, 11, 5, '13', 'completado', 30, 6, '00:00:53', 14),
(32, 12, 5, '13', 'en_espera', 0, 0, '00:00', NULL);
...
(3, 8, 5, 'Yane2024 ha completado la lección: \'Conteo hacia adelante/atras\', sobre el tema \'Conteo\'', '2025-01-06 19:34:46');
...
INSERT INTO `ninos` (`id_nino`, `id_rol`, `id_genero`, `id_profesional`, `id_nivel_acceso`, `id_usuario`, `nombre`, `apellido`, `fecha_nacimiento`, `ultimo_acceso`) VALUES
(8, 0, 2, 5, 2, 12, 'Yaneri', 'Perdomo', '2017-01-15', '2025-01-07 23:40:28'),
(9, 0, 1, 5, 3, 13, 'Diamantino', 'Perdomo', '2018-03-02', '2025-01-08 08:40:01');
...
(2, 8, 5, '¡Felicidades! Has completado una leccion mas.', '2025-01-07 21:52:08', 'leido');
...
INSERT INTO `profesionales` (`id_profesional`, `id_cargo`, `id_usuario`, `nombre`, `apellido`, `correo_electronico`, `centro_educativo`) VALUES
(5, 1, 11, 'Taka', 'bastos', 'taka@gmail.com', 'Josefina de Acosta');
...
INSERT INTO `progresos` (`id_progreso`, `id_nivel_acceso`, `id_usuario`, `porcentaje`, `total_diamantes`, `id_profesional`) VALUES
(7, 2, 12, 100, 50, 5),
(8, 3, 13, 75, 22, 5);
...
INSERT INTO `usuarios` (`id_usuario`, `id_rol`, `usuario`, `clave`, `estado`, `fecha_hora_creacion`) VALUES
(11, 1, 'taka2024', '123', b'1', '2025-01-04 22:04:48'),
(12, 2, 'Yane2024', '123', b'1', '2025-01-04 22:11:59'),
(13, 2, 'Diaman', '123', b'1', '2025-01-06 19:57:23');
...
ALTER TABLE `estado_lecciones`
  ...
  ADD KEY `fk_estado_lecciones_profesionales` (`id_profesional`);
...
ALTER TABLE `progresos`
  ...
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `id_nivel_acceso` (`id_nivel_acceso`),
  ADD KEY `fk_progresos_profesionales` (`id_profesional`);
...
--
ALTER TABLE `estado_lecciones`
  MODIFY `id_estado_leccion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `historiales`
  MODIFY `id_historial` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `profesionales`
  MODIFY `id_profesional` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `progresos`
--
ALTER TABLE `progresos`
  MODIFY `id_progreso` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `estado_lecciones`
  ADD CONSTRAINT `fk_estado_lecciones_profesionales` FOREIGN KEY (`id_profesional`) REFERENCES `profesionales` (`id_profesional`);
...
--
ALTER TABLE `progresos`
  ADD CONSTRAINT `fk_progresos_profesionales` FOREIGN KEY (`id_profesional`) REFERENCES `profesionales` (`id_profesional`);
COMMIT;
